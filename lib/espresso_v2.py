...
SWT_MODE  = Pin(11, Pin.IN, Pin.PULL_UP)  # Mode switch
...
HEAT_PWM  = PWM(Pin(9, Pin.OUT), freq=600) # Heating element pulse width modulation pin
...
PUMP_PWM  = PWM(Pin(7, Pin.OUT), freq=600) # Water pump pulse width modulation pin
